...
public class ProviderSanityTest {
    ...
    private static void test(Class<?> klass, String algo, Class<?> expectedSpiClass, String privateFieldName) {
        try {
            ...
            Utils.assertNotNull("Failed to create instances for " + algo, algoInstance);
        } catch (Throwable t) {
            Utils.fail("Failed to create instances for " + algo + ": " + t);
        }
    }

    public static void testDRBG() {
    ...
    public static void testMessageDigests() {
